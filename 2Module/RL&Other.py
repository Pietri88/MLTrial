...
z = np.array([[5, 1000, 2], [10, 5000, 5], [2, 500, 1], [8, 3000, 3], [12, 6000, 6]])

kmeans = KMeans(n_clusters=2, random_state=0).fit(z)

# Wyświetlenie centrów klastrów i etykiet przypisanych klientom
print(f"Cluster Centers: {kmeans.cluster_centers_}")
print(f"Labels: {kmeans.labels_}")


plt.scatter(z[:, 0], z[:, 1], c=kmeans.labels_, cmap='viridis')
plt.xlabel('Liczba zakupów')
plt.ylabel('Całkowite wydatki')
